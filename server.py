...
map_file_path = os.path.join(current_directory, '.', 'static', 'other',
                             'coordinates.npy')
...
def index():
    ...
    for event in calendar:
        ...
        event = (event[0], event[1], (day_of_week, month, day_of_month, year,
                                      time), event[3])
        if day_of_month == current_date.day and month.lower(
